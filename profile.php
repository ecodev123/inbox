...
<div class="card2">
        ...
        <p class="about" style="color: #03101f;">Hello, My name is <?php echo $get_user ?>. I am using Inbox.“Your work is going to fill a large part of your life,the only way to do great work is to love what you do.</p>
